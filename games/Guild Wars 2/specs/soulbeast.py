...
def power_soulbeast_rotation(stop_event):
    ...
    while not stop_event.is_set():
        ...
        # Track whether anything was cast this loop (only one skill per loop)
        ...
        # Beast skills — cast at most one (only if no utility cast)
        ...
        # Weapon skill priorities — cast at most one (only if nothing else cast)
